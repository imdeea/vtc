...
class WPLMS_Admin_Welcome {
	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '2 New Features', 'vibe' ); ?></h4>
						<p><?php _e( 'We\'ve added 2 major features, the one click installer has been revamped and the course status page templates.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-5/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Updated one click installer', 'vibe' ); ?></h4>
						<p><?php _e( 'We\'ve updated the one click installer in WPLMS. Is is the more advanced and allows you to optionally import elements from various demos into your current setup.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-5/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Updated One click installer', 'vibe' ); ?></h4>
						<p><img src="https://i.gyazo.com/fb3930504eb293c0fbf282d2e8438ac2.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-one-click-installer/" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Updated Course status page template', 'vibe' ); ?></h4>
						<p><img src="http://image.prntscr.com/image/d876036b6e5a40d3ba427801b99ead99.png" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/course-status-templates/" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Improvements in Certificates', 'vibe' ); ?></h4>
						<p><img src="https://i.gyazo.com/32faf425567af3f0e152f6f621d1e8ca.gif" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/improvements-in-wplms-certificates/" target="_blank" class="button">Tutorial</a>
					</div>
				</div>
			</div>
			<div class="changelog">
	...
	public function welcome() {
		...
		if(!$this->check_installed()){
			...
			if(empty($current_theme) || empty($current_theme->theme_name)){
				$theme_name = 'wplms';
			}else{
				$theme_name = $current_theme->theme_name;
			}
			wp_redirect( admin_url( 'themes.php?page='.$theme_name.'-setup' ) );
		}else{
